  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-center gap-2 group">
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-300"
      >
